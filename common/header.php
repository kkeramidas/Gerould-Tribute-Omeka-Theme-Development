...
<script type="text/javascript" src="<?php echo WEB_ROOT;?>/themes/gerould-tribute/common/lightbox/js/prototype.js"></script>
<script type="text/javascript" src="<?php echo WEB_ROOT;?>/themes/gerould-tribute/common/lightbox/js/scriptaculous.js?load=effects,builder"></script>
<script type="text/javascript" src="<?php echo WEB_ROOT;?>/themes/gerould-tribute/common/lightbox/js/lightbox.js"></script>
